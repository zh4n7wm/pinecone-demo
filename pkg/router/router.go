...
type SimRouter interface {
	...
	NewConnectionManager(*http.Client) *connections.ConnectionManager
}
...
func (r *DefaultRouter) NewConnectionManager(client *http.Client) *connections.ConnectionManager {
	return connections.NewConnectionManager(r.rtr, client)
}
